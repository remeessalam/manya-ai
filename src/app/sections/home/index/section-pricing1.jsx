      ...
      <div className="container">
        ...
        <div className="section-content">
          <div className="sx-p-table-section">
            {/*Block One*/}
            <div
              className="sx-p-table-bx-1 wow fadeInDown t-r-first"
            ...
            {/*Block two*/}
            <div
              className="sx-p-table-bx-2 wow fadeInDown t-r-two"
              data-wow-duration="1000ms"
            >
            ...
            {/*Block four*/}
            <div
              className="sx-p-table-bx-2 wow fadeInDown t-r-four"
              data-wow-duration="1000ms"
            >
              <div className="sx-p-table-bx-2-top-title">
                <span>Advanced</span>
            ...
            {/*Block five*/}
            <div
              className="sx-p-table-bx-2 wow fadeInDown t-r-five"
              data-wow-duration="1000ms"
            >
              <div className="sx-p-table-bx-2-top-title">
