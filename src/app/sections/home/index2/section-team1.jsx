                ...
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    ...
                    <h4 className="sx-title">
                      <NavLink to="/team">Michael Smith</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    <p>Managing Director</p>
                    <h4 className="sx-title">
                      <NavLink to="/team">Delilah Brooklyn</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    <p>Managing Director</p>
                    <h4 className="sx-title">
                      <NavLink to="/team">Leilani Kennedy</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="our-team-2">
                  ...
                  <div className="figcaption">
                    <p>Managing Director</p>
                    <h4 className="sx-title">
                      <NavLink to="/team">Bella Natalia</NavLink>
                    </h4>
                  </div>
                </div>
              </div>
